...
- **Декор**: фирменная звёздочка ✦ (3 цвета), россыпи искр, звёзды,
  ...
  волнистые линии, вертикальные палочки, скобки, флажки-закладки
...
шрифт [Neucha](https://fonts.google.com/specimen/Neucha), OFL — скачивается отдельно):

```bash
pip install pillow cairosvg
# положите neucha.ttf рядом со скриптом
python3 generate.py
```
